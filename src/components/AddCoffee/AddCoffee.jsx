...
const AddCoffee = () => {
  ...
  return (
    <div className=" w-full min-h-svh bg-blue-50 pb-5 ">
      <div className="max-w-[1180px] rounded-b-2xl mx-auto py-10 pt-8 text-black bg-blue-50 px-3 sm:px-8 [box-shadow:_-6px_5px_18px_rgba(131,131,131,0.94)]">
        <h1
 ...
 md:text-3xl text-2xl text-center font-bold italic"
        ...
        <p className="py-5 md:px-20 text-gray-900 text-justify">
          ...
          in a cozy, welcoming space. Every cup is crafted with care by our
